module CalculatorViews {
    ...
    class WellsScore extends View {
        description = new WellsScoreDescription();
    ...
    class WellsScoreDescription extends ViewDescription implements IViewDescription {
    ...
    viewsCollection.add(new WellsScoreDescription());
}
